##########################################################
#        Create Virtual Private Switch in Hyper-V        #
#                                                        #
#                                                        # 
#                Microsoft Learning                      #
#                                                        #
...
########## Create Private Virtual Switch on Hyper-V Host #######################################
...
# See if a Private Switch named "Private Network 2" already exists and assign True or False value to the Variable to track if it does or not
$PrivateNetwork2VirtualSwitchExists = ((Get-VMSwitch | where {$_.name -eq "Private Network 2" -and $_.SwitchType -eq "Private"}).count -ne 0)

# If statement to check if Private Switch already exists. If it does write a message to the host 
# saying so and if not create Private Virtual Switch
if ($PrivateNetwork2VirtualSwitchExists -eq "True")
{
write-host "< Private Network 2 >   ---- switch already Exists"
} 
else
{
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUdTvMB3Bnkg7zuz91mVxR3FIM
# l3egghWCMIIEwzCCA6ugAwIBAgITMwAAADPlJ4ajDkoqgAAAAAAAMzANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFF9z
# WMMlrSh4o+X2pUOW+9bPrJNmMF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBADr5RByaqBxL8gRI
# eqLCsLULFQ4gr+Pi5v6/31gasLHX15lghe4QaaFWYym8Vx1D70TDuEErbdwP/4Zd
# EgvFbWyg+nSf5bXa1Hy15JceOsI51v7MFA8dFvcYj1LkvoKxmGp6nwEobYPlE8ho
# qxlPj+OjUnmSoyIg/Ks1keKxfvuV7LRQiEwkUL0bQ9kfluxgSiYqu2wnebzwNAAd
# mEPzyCUKquIB0cohq1DD81l72bq2ZEf5IHnflNuXVRB0LH+ST5Y20SnEMRPeReni
# 6ziJGKil3WQb2JFahzZ/Jb2NZ9zU3SQPwEaIPl+I7Wd+Ce+6ATYENh4P3DJV6eRH
# 3SOs67ehggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MjcwNzQzNDdaMCMGCSqGSIb3DQEJBDEWBBQK31OIyVDbR5/VFvxcwglnlvrdIjAN
# BgkqhkiG9w0BAQUFAASCAQCh7GieLU2oEJFUpD76RFXX8aWjKkNBlpPVSxeyHh5t
# 9oZNXoTG3GOfp9e9euWz7iyzh4qHmgRHP87+ywS5XgizCzNlcGZAqIIiNNTggyaN
# mvnQk6CaduYxPT+VEhxUY5CxQLDVogcmjyydsWE9fAeLAAYBIYIr9Lxlhsrwd491
# lq7eVKx386500fV3vmSegeNDFVudSOOXgqzIMJnzta+eTDxLij9q0zAc/e7mvHQF
# 1/aXusx5OLTcJF0GvcrdnXO+/Wq/nZ5n8tcH+GdS7wxE6AeI08WDmDJLwJU2xtD4
# M8o7qqSY6v7kEkueMuxhucAq9TZw67dJwe9twyNEt3It
