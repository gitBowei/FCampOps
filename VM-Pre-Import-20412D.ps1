...
$path2 = $drive2 + ":\Program Files\Microsoft Learning\20412\Drives\"


Set-VHD -Path (Get-Item ($path2 + "20412D-LON-DC1\Virtual Hard Disks\20412D-LON-DC1.vhd")) -ParentPath (Get-Item ($path + "Drives\MT14A-LON-DC1.vhd"))
Set-VHD -Path (Get-Item ($path2 + "20412D-LON-CL1\Virtual Hard Disks\20412D-LON-CL1.vhd")) -ParentPath (Get-Item ($path + "Base14C-W81-Office2013.vhd"))
Set-VHD -Path (Get-Item ($path2 + "20412D-LON-CL2\Virtual Hard Disks\20412D-LON-CL2.vhd")) -ParentPath (Get-Item ($path + "Base14C-W81-Office2013.vhd"))
Set-VHD -Path (Get-Item ($path2 + "20412D-LON-SVR1\Virtual Hard Disks\20412D-LON-SVR1.vhd")) -ParentPath (Get-Item ($path + "Base14A-WS12R2.vhd"))
Set-VHD -Path (Get-Item ($path2 + "20412D-LON-SVR2\Virtual Hard Disks\20412D-LON-SVR2.vhd")) -ParentPath (Get-Item ($path + "Base14A-WS12R2.vhd"))
Set-VHD -Path (Get-Item ($path2 + "20412D-LON-SVR3\Virtual Hard Disks\20412D-LON-SVR3.vhd")) -ParentPath (Get-Item ($path + "Base14A-WS12R2.vhd"))
Set-VHD -Path (Get-Item ($path2 + "20412D-LON-SVR4\Virtual Hard Disks\20412D-LON-SVR4.vhd")) -ParentPath (Get-Item ($path + "Base14A-WS12R2.vhd"))
Set-VHD -Path (Get-Item ($path2 + "20412D-TREY-DC1\Virtual Hard Disks\20412D-TREY-DC1.vhd")) -ParentPath (Get-Item ($path + "Base14A-WS12R2.vhd"))
Set-VHD -Path (Get-Item ($path2 + "20412D-TREY-CL1\Virtual Hard Disks\20412D-TREY-CL1.vhd")) -ParentPath (Get-Item ($path + "Base14C-W81-Office2013.vhd"))
Set-VHD -Path (Get-Item ($path2 + "20412D-LON-CA1\Virtual Hard Disks\20412D-LON-CA1.vhd")) -ParentPath (Get-Item ($path + "Base14A-WS12R2.vhd"))
Set-VHD -Path (Get-Item ($path2 + "20412D-TOR-DC1\Virtual Hard Disks\20412D-TOR-DC1.vhd")) -ParentPath (Get-Item ($path + "Base14A-WS12R2.vhd"))
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQULOTJ60UUbEYoogUQa4RWLAu9
# NPSgghWCMIIEwzCCA6ugAwIBAgITMwAAAEyh6E3MtHR7OwAAAAAATDANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFHZd
# 8e3gGtFNQTAnUCeLykB6vhC1MF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBAMwcoOarYhIPBxUv
# nG1dMMbwTkgG82qoF/0lp9cwi9AENe8dgyKK3UifOMNlVGjWDsXe+biYdonSsqBS
# J83k2z2BRiBwCAml4x70vo7B0aWdjQqnLSJ3RnXgoNMadZf8I9vUJP/yzBhG5Z2R
# DV8G8kYQBup1SoE8/DY1I0M+nTgkEh82M1l+zsSHHoK4yciMTnxkmpF018PDtoO0
# NYf/2UZyywOp4pddamkOzHcPbk9sYlr4437k+9Y9tUOXXMwvU3AK4fMWpem9riPH
# dXMTe4GTAKfcIkvFWafDM/GxOrXOU4DYZlTde79CKcA/arMM5LVcSF4rEVwOwq1+
# iHhTigyhggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MjcwNzQzNDdaMCMGCSqGSIb3DQEJBDEWBBTCeeOs0iS4GRE2Uu5aEAIIuBZCZzAN
# BgkqhkiG9w0BAQUFAASCAQCD4yyLWlq1TumlawDRK/LmildU72wvOeDHrbnS18Ji
# VnVQzZF14Qb4AhuIe/FkgoLer+sB5bygrk/IJWPt6vlCg0jdGVHnB7u4oihI+Azm
# FBlkTBrD1JgyfY0hN59Lj0ZDwZcbPNiCjwJ9p0/NXRhCehtKw3DpS7Aw/VZfJiFg
# z7+Yo8AbP+fOnbdXCfKe/Q1K+9YV5iojh1mqzsRCZ1UoDEcRgxwxtGvF5fpveW/E
# lSHirfC0P3CxBdhlioHwUEgK+TcQ+MkUxKyL8qsbiojdAO5AMLWX1tN0qzNSdRib
# UdAKW0/Jpb7tr2/jB5db0/u2Z4JB/V+S5DGsqgKQpxwV
