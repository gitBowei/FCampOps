...
$rgName="Office365Demo"
$locName="EastUS2"
New-AzResourceGroup -Name $rgName -Location $locName

$rgName="Office365Demo"
$locName=(Get-AzResourceGroup -Name $rgName).Location
$corpnetSubnet=New-AzVirtualNetworkSubnetConfig -Name Corpnet -AddressPrefix 10.0.0.0/27
...
Set-AzVirtualNetworkSubnetConfig -VirtualNetwork $vnet -Name Corpnet -AddressPrefix "10.0.0.0/27" -NetworkSecurityGroup $nsg
...
New-SmbShare -name files -path c:\files -changeaccess LABFIELD\User1
