...
$pw = convertto-securestring -AsPlainText -Force -String “St3ph4n13.”
$cred = new-object -typename System.Management.Automation.PSCredential -argumentlist $username,$pw
Write-Output "CERRANDO SESIONES PREVIAS"
...
Foreach ($objUser in $objUsers){
    ...
    for($c=1;$c -lt 1001; $c++){
       ...
       $messages=Get-MessageTrace -SenderAddress $objUser -StartDate $DateStart -EndDate $DateEnd -PageSize 5000 -Page $c
     ...
     ##if(($messages).count -gt 0){
       if($messages -eq $null){       
               break;
                        ...
                        Get-MessageTrace -SenderAddress $objUser -StartDate $DateStart -EndDate $DateEnd -PageSize 5000 -AsJob -Page $c | Select-Object MessageTraceId,MessageID,SenderAddress,
